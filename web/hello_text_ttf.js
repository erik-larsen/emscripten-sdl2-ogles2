...
// include: /var/folders/7y/v1yzr63d61sdmkfs6rvh_g7m0000gq/T/tmp1jqjjs5e.js
  ...
  (() => {
    ...
    function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'web/hello_text_ttf.data';
...
Module['FS_createPath']("/", "media", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_web/hello_text_ttf.data');

      };
      Module['addRunDependency']('datafile_web/hello_text_ttf.data');
...
// end include: /var/folders/7y/v1yzr63d61sdmkfs6rvh_g7m0000gq/T/tmp1jqjjs5e.js
// include: /var/folders/7y/v1yzr63d61sdmkfs6rvh_g7m0000gq/T/tmp3r85sppr.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if ((typeof ENVIRONMENT_IS_WASM_WORKER != 'undefined' && ENVIRONMENT_IS_WASM_WORKER) || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD) || (typeof ENVIRONMENT_IS_AUDIO_WORKLET != 'undefined' && ENVIRONMENT_IS_AUDIO_WORKLET)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: /var/folders/7y/v1yzr63d61sdmkfs6rvh_g7m0000gq/T/tmp3r85sppr.js
// include: /var/folders/7y/v1yzr63d61sdmkfs6rvh_g7m0000gq/T/tmprbwkpxul.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: /var/folders/7y/v1yzr63d61sdmkfs6rvh_g7m0000gq/T/tmprbwkpxul.js
...
function findWasmBinary() {
    return locateFile('hello_text_ttf.wasm');
}
...
var ASM_CONSTS = {
 ...
 353822: ($0, $1, $2, $3, $4) => { var w = $0; var h = $1; var hot_x = $2; var hot_y = $3; var pixels = $4; var canvas = document.createElement("canvas"); canvas.width = w; canvas.height = h; var ctx = canvas.getContext("2d"); var image = ctx.createImageData(w, h); var data = image.data; var src = pixels / 4; var dst = 0; var num; if (typeof CanvasPixelArray !== 'undefined' && data instanceof CanvasPixelArray) { num = data.length; while (dst < num) { var val = HEAP32[src]; data[dst ] = val & 0xff; data[dst+1] = (val >> 8) & 0xff; data[dst+2] = (val >> 16) & 0xff; data[dst+3] = (val >> 24) & 0xff; src++; dst += 4; } } else { var data32 = new Int32Array(data.buffer); num = data32.length; data32.set(HEAP32.subarray(src, src + num)); } ctx.putImageData(image, 0, 0); var url = hot_x === 0 && hot_y === 0 ? "url(" + canvas.toDataURL() + "), auto" : "url(" + canvas.toDataURL() + ") " + hot_x + " " + hot_y + ", auto"; var urlBuf = _malloc(url.length + 1); stringToUTF8(url, urlBuf, url.length + 1); return urlBuf; },  
 354810: ($0) => { if (Module['canvas']) { Module['canvas'].style['cursor'] = UTF8ToString($0); } },  
 354893: () => { if (Module['canvas']) { Module['canvas'].style['cursor'] = 'none'; } },  
 354962: () => { return window.innerWidth; },  
 354992: () => { return window.innerHeight; }
};
