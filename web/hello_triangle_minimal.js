...
function findWasmBinary() {
    return locateFile('hello_triangle_minimal.wasm');
}
...
var ASM_CONSTS = {
 ...
 124518: ($0) => { if (Module['canvas']) { Module['canvas'].style['cursor'] = UTF8ToString($0); } },  
 124601: () => { if (Module['canvas']) { Module['canvas'].style['cursor'] = 'none'; } },  
 124670: () => { return window.innerWidth; },  
 124700: () => { return window.innerHeight; }
};
var wasmImports = {
  /** @export */
