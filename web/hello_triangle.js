...
var ASM_CONSTS = {
 ...
 124690: ($0) => { if (Module['canvas']) { Module['canvas'].style['cursor'] = UTF8ToString($0); } },  
 124773: () => { if (Module['canvas']) { Module['canvas'].style['cursor'] = 'none'; } },  
 124842: () => { return window.innerWidth; },  
 124872: () => { return window.innerHeight; }
};
var wasmImports = {
  /** @export */
