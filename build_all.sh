...
set -o verbose
emcc -std=c++11 hello_triangle_minimal.cpp -s USE_SDL=2 -s FULL_ES2=1 -s WASM=1 -o web/hello_triangle_minimal.js
emcc -std=c++11 hello_triangle.cpp events.cpp camera.cpp -s USE_SDL=2 -s FULL_ES2=1 -s WASM=1 -o web/hello_triangle.js
emcc -std=c++11 hello_texture.cpp events.cpp camera.cpp -s USE_SDL=2 -s USE_SDL_IMAGE=2 -s SDL2_IMAGE_FORMATS="[""png""]" -s FULL_ES2=1 -s WASM=1 --preload-file media/texmap.png -o web/hello_texture.js
